...
<main id="main">
    ...
    <div class="tf-container">
        ...
        <div class="col-lg-12 center z-index1">
            <h1 class="title"> All Medical</h1>
            <ul class="breadcumb-list flex-five">
            <li><a href="{{ route('frontend.index') }}">Home</a></li>
            <li><span> All Medical</span></li>
            </ul>
    ...
    <section class="tour-destination pd-main">
        <div class="tf-container">
            <div class="row">
                        ...
                        <div class="tf-widget-destination">
                            ...
                            <div class="destination-content">
                                ...
                                <div class="flex-two btn-destination">
                                    <h6 class="title"><a href="{{ route('tourDetails', $item->slug) }}">View all</a></h6>
                ...
                @empty
                    <div class="col-12">
                        <p>No all found for this category.</p>
                    </div>
                @endforelse
            </div>
        </div>
