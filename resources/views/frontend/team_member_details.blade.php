...
@section('content')
  ...
  @include('frontend.partials.breadcrumb', ['title' => ' Team Members Details'])
                    ...
                    <div class="tf-container">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="image-about-h4-wrap relative">
                                    <div class="image-about-item relative about-wrap-left">
                                        ...
                                        {{-- <img src="{{ asset('uploads/about/' . $about->image1) }}" alt="image" class="shape-about-h4"> --}}

                                        {{-- <span class="quote">25,000 + Customer Worldwide</span> --}}

                                    </div>
                                    <div class="image-about-item relative about-wrap-right">
                                        <img src="{{ asset("uploads/teamMember/$teamMember->image") }}" alt="image">
                                        {{-- <img src="{{ asset('uploads/about/' . $about->image1) }}" alt="image" class="shape-about-h4"> --}}
                            ...
                            <div class="col-md-6 inner-content-about">
                                <div class="mb-30">
                                    <span class="sub-title-heading text-main font-yes fs-28-46">{{$teamMember->name}}</span>
                                    <h2 class="title-heading mb-18">{{$teamMember->management->name}} <span
                                            class="text-gray font-yes">

                                        </span> </h2>
                                        <h2 class="title-heading mb-18">{{$teamMember->designation->name}} <span
                                            class="text-gray font-yes">

                                        </span> </h2>
                                    <p class="des">{!! $teamMember->description !!}</p>
                                </div>
                                {{-- <div class="row">
                                    <div class="col-md-6">
