                    ...
                    <div class="tf-container">
                        <div class="row">
                            ...
                            <div class="col-md-6 inner-content-about">
                                <div class="mb-30">
                                    <span class="sub-title-heading text-main font-yes fs-28-46">{{$about->title}}</span>
                                    <h2 class="title-heading mb-18">{{$about->subtitle}} <span
                                            class="text-gray font-yes">

                                        </span> </h2>
                                    <p class="des">{!! $about->description !!}</p>
                                </div>
                                {{-- <div class="row">
                                    <div class="col-md-6">
