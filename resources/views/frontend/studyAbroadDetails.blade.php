...
<section class="studyAbroad-single">
        ...
        <div class="row pd-main">
            <div class="col-lg-12">
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-information" role="tabpanel"
                            ...
                            <div class="col-lg-12">
                                <div class="inner-heading-wrap flex-two">
                                    <div class="inner-heading">
                                        ...
                                        <h2 class="title">{{$studyAbroad->title}}</h2>
                                        <ul class="flex-three list-wrap-heading">
                                            ...
                                            <li class="flex-three">
                                                <i class="icon-user"></i>
                                                <span>Guests: {{ $studyAbroad->guests }}</span>
                                            </li>
                                            <li class="flex-three">
                                                <i class="icon-18"></i>
                                                <span>{{$studyAbroad->location}}</span>
                                            </li>
                                    ...
                                    <div class="inner-price">
                                      ...
                                      <p class="price-sale text-main">
                                        @if($studyAbroad->discount)
                                            ৳ {{ $studyAbroad->discount }}
                                            <span class="price line-through">৳ {{ $studyAbroad->price }}</span>
                                        @else
                                            ৳ {{ $studyAbroad->price }}
                                        @endif
                                    </p>
                        ...
                        <div class="row mb-40 image-gallery-single">
                            ...
                            <div class="col-12 col-sm-12">
                                <img src="{{ asset('uploads/studyAbroad/' . $studyAbroad->image)}}" alt="image" style="height: 450px">
                            </div>

                        </div>
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="information-content-studyAbroad">
                                    <div class="description-wrap mb-40">
                                        <span class="description">Description:</span>
                                        <p class="des">{!! $studyAbroad->description !!}</p>
                                    </div>
                            ...
                            <div class="col-lg-4">
                                <div class="side-bar-right">
                                    <div class="sidebar-widget">
                                        <h6 class="block-heading">Book This studyAbroad</h6>
                                        <form action="{{ route('bookings.store') }}" method="POST" id="form-book-studyAbroad">
                                            @csrf
                                    ...
                                    <div class="sidebar-widget">
                                        ...
                                        <ul class="category-confidence">
                                            ...
                                            <li class="flex-three">
                                                ...
                                                <span>Hand-picked studyAbroads & Activities</span>
                                            </li>
                                            <li class="flex-three">
                    ...
                    <div class="tab-pane fade" id="pills-studyAbroad-planing" role="tabpanel"
                        aria-labelledby="pills-studyAbroad-planing-tab" tabindex="0">
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="planing-content-studyAbroad">
                                    <h3 class="title-plan">studyAbroad Plan :</h3>
                                    <div class="studyAbroad-planing-section flex">
                            ...
                            <div class="col-lg-4">
                                <div class="side-bar-right">
                                    <div class="sidebar-widget">
                                        <h6 class="block-heading">Book This studyAbroad</h6>
                                        <form action="/" id="form-book-studyAbroad">
                                            <div class="input-wrap mb-30">
                                                <input type="date">
                                            </div>
                    ...
                    <div class="tab-pane fade" id="pills-location-share" role="tabpanel"
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="localtion-content-studyAbroad">
                    ...
                    <div class="tab-pane fade" id="pills-reviews" role="tabpanel"
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="review-content-studyAbroad">
                    ...
                    <div class="tab-pane fade" id="pills-shot-gallery" role="tabpanel"
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="gallery-content-studyAbroad">
