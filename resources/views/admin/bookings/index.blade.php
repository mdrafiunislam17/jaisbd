        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="{{ route("bookings.create") }}"
               class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                    class="fas fa-plus fa-sm text-white-50"></i> Create bookings</a>
        </div>
                    ...
                    <table class="table table-bordered" id="dataTable">
                        ...
                        @foreach($booking as $i => $career)
                            <tr>
                             ...
                             <td>
                                    @if ($career->status === 'successful')
                                        <span class="badge badge-success badge-counter">{{ ucfirst($career->status) }}</span>
                                    @else
                                        <span class="badge badge-danger badge-counter">{{ ucfirst($career->status) }}</span>
                                    @endif
                                </td>
