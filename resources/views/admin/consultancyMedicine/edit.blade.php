...
@section("title", "Edit Medical Consultancy")
@section("content")
    <div class="container-fluid">
        <!-- Page Heading -->
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Edit Medical Consultancy</h1>
            <a href="{{ route("consultancy-medicine.index") }}"
               class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                    class="fas fa-eye fa-sm text-white-50"></i> Medical Consultancy</a>
        </div>
        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                <form action="{{ route('consultancy-medicine.update', $consultancyMedicine->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-sm-6">
                            <select name="category_id" id="category_id" class="form-control">
                                ...
                                @foreach($categories as $category)
                                    <option value="{{ $category->id }}" {{ old('category_id', $consultancyMedicine->category_id) == $category->id ? 'selected' : '' }}>
                                        {{ $category->name }}
                                    </option>
                                @endforeach
                            </select>
   ...
   <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="title" name="title"
                                   value="{{ old('title', $consultancyMedicine->title) }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="slug" name="slug"
                                   value="{{ old('slug', $consultancyMedicine->slug) }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="location" name="location"
                                   value="{{ old('location', $consultancyMedicine->location) }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="duration" name="duration"
                                   value="{{ old('duration', $consultancyMedicine->duration) }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="date" class="form-control" id="start_date" name="start_date"
                                   value="{{ old('start_date', $consultancyMedicine->start_date) }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="date" class="form-control" id="end_date" name="end_date"
                                   value="{{ old('end_date', $consultancyMedicine->end_date) }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <textarea name="description" id="description" class="form-control"
                                      rows="5">{{ old('description', $consultancyMedicine->description) }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            @if($consultancyMedicine->image)
                                <img src="{{ asset('uploads/consultancyMedicine/' . $consultancyMedicine->image) }}" alt="consultancyMedicine Image" class="mb-2" style="max-height: 100px;">
                            @endif
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="guests" value="{{ old("guests", $consultancyMedicine->guests) }}"
                                   name="guests">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="number" class="form-control" id="price" name="price"
                                   value="{{ old('price', $consultancyMedicine->price) }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="number" class="form-control" id="discount" name="discount"
                                   value="{{ old('discount', $consultancyMedicine->discount) }}">
                        </div>
                    </div>
                       ...
                       <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="number" class="form-control" id="sort" value="{{ $consultancyMedicine->sort }}"
                                   name="sort">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <select name="status" id="status" class="form-control">
                                <option value="1" {{ old('status', $consultancyMedicine->status) == 1 ? 'selected' : '' }}>Active</option>
                                <option value="0" {{ old('status', $consultancyMedicine->status) == 0 ? 'selected' : '' }}>Inactive</option>
                            </select>
                        </div>
                    </div>
