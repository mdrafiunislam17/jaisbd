...
@section("title", "Create Medical Consultancy")
@section("content")
    <div class="container-fluid">
        <!-- Page Heading -->
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Create Medical Consultancy</h1>
    ...
    <!-- DataTales Example -->
        <div class="card shadow mb-4">
            <div class="card-body">
                <form action="{{ route("consultancy-medicine.store") }}" method="post" enctype="multipart/form-data">
                    @csrf
