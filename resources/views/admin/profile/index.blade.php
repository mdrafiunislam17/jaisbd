            ...
            <div class="card-body">
                <form action="{{ route("profile.update") }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-4">
                     ...
                     <div class="form-group row mb-4">
                    <label for="phone_number" class="col-sm-3 col-form-label text-right font-weight-bold">Phone Number</label>
                    <div class="col-sm-6">
                ...
                <div class="form-group row mb-4">
                    <label for="image" class="col-sm-3 col-form-label text-right font-weight-bold">Profile Image</label>
                    <div class="col-sm-6">
                        <input type="file" class="form-control-file" id="image" name="image">
                        @if($user->image)
                            <div class="mt-2">
                                <img src="{{ asset("uploads/user/$user->image") }}" alt="Profile Image" width="120" class="img-thumbnail">
                            </div>
                        @endif
                    </div>
                </div>
