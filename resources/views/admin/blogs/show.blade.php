            ...
            <div class="card-body">
                <form action="{{ route("admin.blogs.update", $blog->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <textarea name="short_detail" id="short_detail"
                                      class="form-control" @style(["height: 160px"]) disabled>{{ $blog->short_detail }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <textarea name="detail" id="detail" class="form-control" disabled>{{ $blog->detail }}</textarea>
                        </div>
                    </div>
