...
@section("content")
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Tour categories</h1>
            <a href="{{ route("tour-categorics.create") }}"
               class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                    class="fas fa-plus fa-sm text-white-50"></i> Create Tour categoriess</a>
        </div>
                        ...
                        @foreach( $categories as $i => $categorie)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route("tour-categorics.edit", $categorie->id) }}" class="btn btn-sm btn-warning"><i
                                            class="fa fa-edit"></i></a>
                                    <form action="{{ route('tour-categorics.destroy', $categorie->id) }}" method="post" class="d-inline delete-form" data-id="{{ $categorie->id }}">
                                        @csrf
                                        @method('DELETE')
