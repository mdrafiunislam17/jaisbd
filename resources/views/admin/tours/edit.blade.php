            ...
            <div class="card-body">
                <form action="{{ route('tours.update', $tour->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            @if($tour->image)
                                <img src="{{ asset('uploads/tour/' . $tour->image) }}" alt="Tour Image" class="mb-2" style="max-height: 100px;">
                            @endif
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="number" class="form-control" id="discount" name="discount"
                                   value="{{ old('discount', $tour->discount) }}">
                        </div>
                    </div>
                       ...
                       <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="number" class="form-control" id="sort" value="{{ $tour->sort }}"
                                   name="sort">
                        </div>
                    </div>
