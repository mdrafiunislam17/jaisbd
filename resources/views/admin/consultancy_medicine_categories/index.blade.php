...
@section("title", "Medical Consultancy Categories")
@section("content")
    <div class="container-fluid">
        <!-- Page Heading -->
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Medical Consultancy Categories</h1>
            <a href="{{ route("consultancy-medicine-categories.create") }}"
                        ...
                        @foreach( $categories as $i => $categorie)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route("consultancy-medicine-categories.edit", $categorie->id) }}" class="btn btn-sm btn-warning"><i
                                            class="fa fa-edit"></i></a>
                                    <form action="{{ route('consultancy-medicine-categories.destroy', $categorie->id) }}" method="post" class="d-inline delete-form" data-id="{{ $categorie->id }}">
                                        @csrf
                                        @method('DELETE')
